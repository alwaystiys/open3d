...
bool UIContext::init(IWindow* window)
{
	...
	ImFont* fontTTF = io.Fonts->AddFontFromFileTTF("../assets/font/AdobeHeiti.ttf", 12.0f, nullptr, io.Fonts->GetGlyphRangesChineseFull());
...
void UIContext::createHostWindow()
{
	...
	{
		// default layout answer find in https://github.com/ocornut/imgui/issues/4430
		...
		if (first_time)
		{
			...
			auto dock_id_right = ImGui::DockBuilderSplitNode(dockspace_id, ImGuiDir_Right, 1.f, nullptr, &dock_id_left);
